...
import { findNookById } from '../fn/book/find-nook-by-id';
import { FindNookById$Params } from '../fn/book/find-nook-by-id';
...
export class BookService extends BaseService {
  ...
  /** Path part for operation `findNookById()` */
  static readonly FindNookByIdPath = '/books/{book-id}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `findNookById()` instead.
   *
   * This method doesn't expect any request body.
   */
  findNookById$Response(params: FindNookById$Params, context?: HttpContext): Observable<StrictHttpResponse<BookResponse>> {
    return findNookById(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `findNookById$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  findNookById(params: FindNookById$Params, context?: HttpContext): Observable<BookResponse> {
    return this.findNookById$Response(params, context).pipe(
